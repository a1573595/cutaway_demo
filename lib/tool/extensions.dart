...
extension ContextGoRouterHelper on BuildContext {
  void goWithLogin(String location, {Object? extra}) async {
    var isLogin = await sharedPrefs.getIsLogin();
  ...
  void pushWithLogin(String location, {Object? extra}) async {
    var isLogin = await sharedPrefs.getIsLogin();
  ...
  void replaceWithLogin(String location, {Object? extra}) async {
    var isLogin = await sharedPrefs.getIsLogin();
